---
title: "{tidytof}: A user-friendly framework for scalable and highly reproducible mass cytometry data analysis"
subtitle: "Supplementary Information"
author: "Timothy Keyes, Yu-Chen Lo, Abhishek Koladiya, Garry P. Nolan, and Kara L. Davis"
date: "`r Sys.Date()`"
output:
  pdf_document: 
    toc: true
...
|                      | - tof_metacluster_hierarchical()| smaller, user-specified number of |
|                      | - tof_metacluster_kmeans()      | metaclusters using several common |
|                      | - tof_metacluster_phenograph()  | methods.                          |
+----------------------+---------------------------------+-----------------------------------+
