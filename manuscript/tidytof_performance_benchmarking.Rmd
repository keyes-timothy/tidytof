...
num_repeats <- 10L
charizard <- 
  c("base" = "#207394", "tidytof" = "#cd5241", "flowcore" = "#eeb45a")
engine_labels <- 
  c("base" = "base", "tidytof" = "tidytof", "flowcore" = "flowCore")
...
```{r run_all_benchmarking, warning = FALSE, message = FALSE}
